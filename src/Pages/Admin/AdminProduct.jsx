...
import { deleteProduct, getAllProductsAdmin, getAllSellers, handleApprove, handleReject } from '../../services/productService';
import gsap from 'gsap';
import { Filter, Plus, Search } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { toast } from 'react-toastify';

const AdminProduct = ({ darkMode }) => {
  ...
  useEffect(() => {
    const fetchAllData = async () => {
      try {
        ...
        else console.error('Invalid seller response:', sellersRes);
      } catch (err) {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    const matchesSeller = selectedSeller ? product.seller?._id === selectedSeller : true;
